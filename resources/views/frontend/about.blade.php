...
@section('content')
    ...
    <section class="about section">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <img class="img-responsive" src="{{ asset('execute/images/about/about.jpg') }}">
                </div>
                <div class="col-md-6">
                    <h2 class="mt-40">Tentang Kami</h2>
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nam qui vel cupiditate exercitationem, ea
                        fuga est velit nulla culpa modi quis iste tempora non, suscipit repellendus labore voluptatem dicta
                        amet?</p>
                    <a href="#!" class="btn btn-main mt-20">Unduh Profil Perusahaan</a>
                </div>
            </div>
            <div class="row mt-40">
                <div class="col-md-3 text-center">
                    <img src="{{ asset('execute/images/about/awards-logo.png') }}">
                </div>
                <div class="col-md-3 text-center">
                    <img src="{{ asset('execute/images/about/awards-logo.png') }}">
                </div>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="team-member text-center">
                        <img class="img-circle" src="{{ asset('execute/images/team/team-1.jpg') }}">
                ...
                <div class="col-md-3">
                    <div class="team-member text-center">
                        <img class="img-circle" src="{{ asset('execute/images/team/team-2.jpg') }}">
                ...
                <div class="col-md-3">
                    <div class="team-member text-center">
                        <img class="img-circle" src="{{ asset('execute/images/team/team-3.jpg') }}">
                        <h4>John Fexit</h4>
                        <p>Shop Manager</p>
                    </div>
                </div>
