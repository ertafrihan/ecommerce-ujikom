...
<!-- Page Wrapper -->
<section class="page-wrapper success-msg" style="margin-top: 25vh;">
  <div class="container">
    <div class="row">
      <div class="col-md-6 col-md-offset-3">
        <div class="block text-center">
        	<i class="tf-ion-android-checkmark-circle"></i>
          <h4 style="margin-top: 20px; margin-bottom: -10px;" class="text-center">Terima kasih!</h4>
          <h2 class="text-center">Pesanan Berhasil Dibuat.</h2>
          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Inventore, sed.</p>
          <a href="{{ route('home') }}" class="btn btn-main mt-20">Halaman Utama</a>
          <a href="{{ route('order-list') }}" class="btn btn-solid-border mt-20">Daftar Transaksi</a>
        </div>
      </div>
    </div>
  </div>
