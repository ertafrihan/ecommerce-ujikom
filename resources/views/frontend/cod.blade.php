                        ...
                        <div class="col-md-8">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    <p>{{ $data['email'] }}</p>
                                    <p>-</p>
                                    <p style="text-transform: uppercase">{{ $data['kurir'] }} - {{ $data['service'] }}</p>
                                    <p></p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="product-checkout-details">
                                <div class="block">
                                    ...
                                    <ul class="summary-prices">
                                        ...
                                        <li>
                                            <span>Total Ongkos Kirim ({{ number_format($data['totalberat'], 0, '', '.') }}
                                                gr)</span>
                                        ...
                                        <div class="payment">
                                            <div class="card-details">
                                                    <img src="{{ asset('execute/images/payment/cash-on-delivery.png') }}"
                                                        alt="cod" style="width: 75px;">
                                                        <p style="float: right; margin-top: 25px;">Cash on Delivery</p>
